...
describe('SignUp Controller', () => {
  test('Should return 400 if no name is provided', async () => {
    ...
    expect(httpResponse).toEqual(HttpHelper.badRequest(new MissingParamError('name')))
  })
  ...
  test('Should return 400 if no password confirmation is provided', async () => {
    ...
    expect(httpResponse).toEqual(HttpHelper.badRequest(new MissingParamError('passwordConfirmation')))
  })
  ...
  test('Should return 400 if password confirmation fails', async () => {
    ...
    expect(httpResponse).toEqual(HttpHelper.badRequest(new InvalidParamError('passwordConfirmation')))
  })
